...
public class SpeechRec extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView.getSettings().setJavaScriptEnabled(true);
		webView.loadUrl("file:///android_asset/code_snippets/speech_rec_java.html");
		
	}
	public void SpeechRecDemo(View view)
	{
		Intent intent = new Intent(this, SpeechRecDemo.class);
